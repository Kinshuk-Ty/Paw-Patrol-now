...
const Products = () => <div className="p-8"><h2>Products</h2><p>Products Page</p></div>;
const Orders = () => <div className="p-8"><h2>Orders</h2><p>Orders Page</p></div>;
const AboutUs = () => (
  <div className="p-8">
    <h2 className="text-2xl font-bold mb-4">About Us</h2>
    <p>We’re a small team of passionate teenagers building India’s first pet product delivery app.</p>
    <p className="mt-2"><strong>Kinshuk Tyagi</strong> (Founder), <strong>Mohd Ayan</strong> (Co-founder), and <strong>Pratik Raj</strong> (Idea Support)</p>
  </div>
);
const Partners = () => <div className="p-8"><h2>Partners</h2><p>Partners Page</p></div>;
const Login = () => (
